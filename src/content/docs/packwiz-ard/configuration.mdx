...
**Configuration files:**
- `common.toml`: The main configuration file for PackWiz-ard, where you can set the URL to your PackWiz `pack.toml` file, configure automatic updates, and set the minimum permission level for the mod's commands.
- `server.toml`: The server-specific configuration file for PackWiz-ard, where you can set the URL to your PackWiz `pack.toml` file, configure automatic updates, and set the minimum permission level for the mod's commands.
