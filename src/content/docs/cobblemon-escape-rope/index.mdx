...
<ReadMore>For crafting recipes, see the [Recipes](/mods/cobblemon-escape-rope/recipes) page.</ReadMore>
<ReadMore>For information about Configuration, see the [Configuration](/mods/cobblemon-escape-rope/configuration) page.</ReadMore>