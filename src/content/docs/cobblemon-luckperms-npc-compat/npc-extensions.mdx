---
title: Cobblemon LuckPerms NPC Compat - NPC Extensions
description: NPC extensions for Cobblemon LuckPerms NPC Compat.
prev: 
  link: /cobblemon-luckperms-npc-compat/
  label: "Overview"
next: false
sidebar:
...
Cobblemon LuckPerms NPC Compat provides the following NPC extensions for use in Cobblemon NPC Molang functionality:
