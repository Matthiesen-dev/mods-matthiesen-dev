...
- **Soul Link** (Optional): Lets two players link their parties together, so that if one player's Cobblemon faints, the other player's corresponding Cobblemon will also faint.
