...
- [Registry Builder API](/mods/matthiesen-lib/registry-builder) - Register content from common code
- [Commands](/mods/matthiesen-lib/commands) - Create cross-platform commands
- [Permissions](/mods/matthiesen-lib/permissions) - Implement permission validation
