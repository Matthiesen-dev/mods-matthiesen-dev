...
- [Permissions](/mods/matthiesen-lib/permissions) - Learn about the permission system
- [Registry Builder](/mods/matthiesen-lib/registry-builder) - Register game content
- Check Minecraft's [brigadier documentation](https://github.com/Mojang/brigadier) for advanced command patterns
