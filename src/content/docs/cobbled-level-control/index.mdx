...
- Optional Client-side: While the mod is server-side only, it also includes an optional client-side component that allows players to view their current level caps and catch rules in-game.
