...
[messages]
	...
	#Allowed Values: VANILLA, EMBERS, ADVENTURE
	textParser = "VANILLA"
...
The text parser to use for messages. This setting determines how messages are formatted and displayed in the game.

- Available Options:
  - `VANILLA` - Uses Minecraft's native text formatting.
  - `EMBERS` - Uses the [Embers Text API](https://tysontheember.dev/embers-text-api/) formatting system.
  - `ADVENTURE` - Uses the [Adventure MiniMessage](https://docs.papermc.io/adventure/minimessage/) text formatting system.
...
[bucketEvent]
	embedPingRole = ""
	embedPingStartEnabled = false
	embedPingEndEnabled = false
...
The Discord Role ID to ping for Spawn Bucket Boost events. If left empty, no role will be pinged.

- Default Value: `""`
- Type: `string`

<ReadMore>For more information on how to find your Discord Role ID, see the [Discord Role ID Guide](https://docs.monni.fyi/blog/role-id).</ReadMore>

#### embedPingStartEnabled

Enables or disables pinging the specified Discord Role for the start of a Spawn Bucket Boost event. When enabled, the role will be mentioned in the webhook message when a Spawn Bucket Boost event starts.
...
Enables or disables pinging the specified Discord Role for the end of a Spawn Bucket Boost event. When enabled, the role will be mentioned in the webhook message when a Spawn Bucket Boost event ends.
...
The Discord Role ID to ping for Catch Boost events. If left empty, no role will be pinged.
...
Enables or disables pinging the specified Discord Role for the start of a Catch Boost event. When enabled, the role will be mentioned in the webhook message when a Catch Boost event starts.
...
Enables or disables pinging the specified Discord Role for the end of a Catch Boost event. When enabled, the role will be mentioned in the webhook message when a Catch Boost event ends.
...
The Discord Role ID to ping for Experience Boost events. If left empty, no role will be pinged.
...
Enables or disables pinging the specified Discord Role for the start of an Experience Boost event. When enabled, the role will be mentioned in the webhook message when an Experience Boost event starts.
...
Enables or disables pinging the specified Discord Role for the end of an Experience Boost event. When enabled, the role will be mentioned in the webhook message when an Experience Boost event ends.
...
The Discord Role ID to ping for Shiny Boost events. If left empty, no role will be pinged.
...
Enables or disables pinging the specified Discord Role for the start of a Shiny Boost event. When enabled, the role will be mentioned in the webhook message when a Shiny Boost event starts.
...
Enables or disables pinging the specified Discord Role for the end of a Shiny Boost event. When enabled, the role will be mentioned in the webhook message when a Shiny Boost event ends.
...
[cache]
	...
	#Active Boosts
	[cache.activeBoosts]
		#The currently active Shiny Boost, serialized as a string
		activeShinyBoost = ""
		#The currently active Catch Boost, serialized as a string
		activeCatchBoost = ""
		#The currently active Experience Boost, serialized as a string
		activeExperienceBoost = ""
		#The currently active Spawn Bucket Boost, serialized as a string
		activeSpawnBucketBoost = ""

	#Queued Boosts
	[cache.queuedBoosts]
		#The queued Shiny Boosts, serialized as a list of strings
		queuedShinyBoosts = []
		#The queued Catch Boosts, serialized as a list of strings
		queuedCatchBoosts = []
		#The queued Experience Boosts, serialized as a list of strings
		queuedExperienceBoosts = []
		#The queued Spawn Bucket Boosts, serialized as a list of strings
		queuedSpawnBucketBoosts = []
```

### Cache Configuration

Unlike the other configuration files, the `cache.toml` file is automatically generated and should not be edited manually. It contains cached data for the boosters, including the currently active boosts and the queued boosts.

If needed, the cache file can be cleared manually, and it will be regenerated automatically in an empty state. However, it is recommended to use the `/boosters clear-queues` command to clear the cache instead of manually editing the file.

#### activeBoosts

The `activeBoosts` section contains the currently active boosts for Shiny, Catch, Experience, and Spawn Bucket. Each boost is serialized as a string and represents the current state of the boost.

#### queuedBoosts

The `queuedBoosts` section contains the queued boosts for Shiny, Catch, Experience, and Spawn Bucket. Each boost is serialized as a list of strings and represents the boosts that are waiting to be activated.