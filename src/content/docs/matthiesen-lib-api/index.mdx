...
This library does nothing on its own - it's a developer tool. If a mod requires Matthiesen Lib API, simply drop it in your `mods` folder alongside the mod that needs it.
:::
...
## Why Use Matthiesen Lib API?

### Write Once, Run Everywhere
Instead of maintaining separate Fabric and NeoForge implementations:

```java
// With Matthiesen Lib API - Write once in common code
