...
```json title="<game_directory>/config/cobblemon_move_tutor/common.json"
{
  "currencyConfig": {
    "currencyType": "item",
    "levelMovePrice": 16,
...
```json title="<game_directory>/config/cobblemon_move_tutor/currency_providers.json"
{
...
```json title="<game_directory>/config/cobblemon_move_tutor/permissions.json"
{
  "permissionlevels": {
