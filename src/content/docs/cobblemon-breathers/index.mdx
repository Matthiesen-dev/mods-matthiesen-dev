...
<ReadMore>For a list of crafting recipes, see the [Recipes](/mods/cobblemon-breathers/recipes) page.</ReadMore>
<ReadMore>For information about Configuration, see the [Configuration](/mods/cobblemon-breathers/configuration) page.</ReadMore>