...
prev: false
next: 
  link: /matthiesen-lib/installation
  label: "Installation"
sidebar:
  order: 1
banner:
...
- [Embers Text API](https://modrinth.com/mod/embers-text-api) - For immersive text features with cross-platform compatibility
...
1. **Add the dependency** - See [Installation](/matthiesen-lib/installation)
